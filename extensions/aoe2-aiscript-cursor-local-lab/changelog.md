...
## v0.1.44
- Rebrand the packaged extension as AOE2 AI Parser under the AOE2 AI Scripters publisher.
- Bundle the parser/linter runtime and local reference data so users do not need a repository checkout for diagnostics.
- Add package-aware diagnostics, generated Markdown reference navigation, semantic coloring, contextual completions, signature help, quick fixes, and package reports.
...
- Fix signatures issue where signatures would highlight the wrong variable [issue [#8](https://github.com/Jvinniec/aoe2-aiscript/issues/8)]
